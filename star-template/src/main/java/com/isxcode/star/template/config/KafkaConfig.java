...
public class KafkaConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, starPluginProperties.getKafkaConfig().get(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG));
        props.put(ConsumerConfig.GROUP_ID_CONFIG, starPluginProperties.getKafkaConfig().get(ConsumerConfig.GROUP_ID_CONFIG));
